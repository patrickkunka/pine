...
export { default as ClassMember } from './ClassMember.js';
export { default as CompoundPunctuator } from './CompoundPunctuator.js';
...
export { default as Keyword } from './Keyword.js';
...
export { default as ParametersExpression } from './ParametersExpression.js';
export { default as Program } from './Program.js';
export { default as Punctuator } from './Punctuator.js';
