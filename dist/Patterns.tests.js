...
describe('Patterns', () => {
    ...
    describe('#STRING', () => {
        it('should recognise a string literal wrapped in double quotes', () => {
            const code = '"foo"';
            const re = new RegExp(_Patterns2.default.STRING);
    ...
    describe('#BOOLEAN', () => {
        it('should recognise a `true` boolean', () => {
            const code = 'true';
            const re = new RegExp(_Patterns2.default.BOOLEAN);
            const match = re.exec(code);
    ...
    describe('#PUNCTUATOR', () => {
        it('should recognise a `-` punctuator', () => {
            const code = '-';
            const re = new RegExp(_Patterns2.default.PUNCTUATOR);
            const match = re.exec(code);
    ...
    describe('#IDENTIFIER', () => {
        it('should recognise a variable identifier', () => {
            const code = 'foo';
            const re = new RegExp(_Patterns2.default.IDENTIFIER);
            const match = re.exec(code);
    ...
    describe('#KEYWORDS', () => {
        it('should recognise a keyword', () => {
            const code = 'this';
            const re = new RegExp(_Patterns2.default.KEYWORD);
            const match = re.exec(code);
    ...
    describe('#NUMBER', () => {
        it('should regonise an integer', () => {
            const code = '3';
            const re = new RegExp(_Patterns2.default.NUMBER);
            const match = re.exec(code);
    ...
    describe('#WHITESPACE', () => {
        it('should recognise a single space character', () => {
            const code = ' ';
            const re = new RegExp(_Patterns2.default.WHITESPACE);
            const match = re.exec(code);
